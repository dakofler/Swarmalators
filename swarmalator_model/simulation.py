...
class Simulation:
    ...
    def init_canvas(self):
        ...
        tk.Label(self.sim, text='Initialization Method').grid(row=1, column=1, sticky='w')
        ...
        # Entry Simulation Type
        tk.Label(self.sim, text='Simulation Type').grid(row=6, column=1, sticky='w')
        self.var_simulation_type = tk.StringVar(self.sim, 'positions')
        tk.Radiobutton(self.sim, text='positions', variable=self.var_simulation_type, value='positions').grid(row=6, column=2)
        tk.Radiobutton(self.sim, text='phases', variable=self.var_simulation_type, value='phases').grid(row=6, column=3)
    ...
    def read_inputs(self):
        ...
        try:
            ...
            self.simulation_type = str(self.var_simulation_type.get())
            return True
        except:
    ...
    def step(self):
        ...
        self.simulation_type = str(self.var_simulation_type.get()) # read simulation type input to make live-switching possible
    ...
    def draw_phases(self):
        ...
        for i in range(self.num_swarmalators):
            ...
            self.canvas.create_oval(x2, y2, x1, y1, fill='black', tags='s')